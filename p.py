...
'Zero-Rated: 0',
'X-Fb-Net-Hni: 41301',
'User-Agent: Dalvik/2.1.0 (Linux; U; Android 7.1.2; G011A Build/N2G48H) [FBAN/FB4A;FBAV/417.0.0.33.65;FBPN/com.facebook.katana;FBLC/en_US;FBBV/480086274;FBCR/Mobitel;FBMF/google;FBBD/google;FBDV/G011A;FBSV/7.1.2;FBCA/x86:armeabi-v7a;FBDM/{density=1.875,width=1600,height=900};FB_FW/1;FBRV/0;]',
'X-Fb-Connection-Quality: MODERATE',
'Authorization: OAuth null',
'Content-Encoding: gzip',
'X-Fb-Sim-Hni: 41301',
'Content-Type: application/x-www-form-urlencoded',
'X-Fb-Connection-Type: WIFI',
'X-Fb-Device-Group: 5379',
